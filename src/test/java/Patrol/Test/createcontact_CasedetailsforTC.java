...
public class createcontact_CasedetailsforTC extends NewBaseTest{
	
@Test(description = "Verify All Contact tab on case details page for Tribunal court Cases")
...
public void allcasedetails() throws InterruptedException, IOException, MessagingException {
    ...
    create.searchAndOpenCase("VIJAY KUMAR SHAH vs. COMMISSIONER OF CUSTOMS (IMPORT) MUMBAI");
    ...
    contact.createcontacts2("Company","Britania", "8867907763", "XYZ@gmail.com", "foodManufacturing", "Delhi");
    
    boolean verifycontact =contact.verifyaddcontact("company");
