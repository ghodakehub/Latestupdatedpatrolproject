...
public class exstingContact_casedetailspageforHC extends NewBaseTest{
	
@Test(description = "Verify All Contact tab on case details page for high court Cases")
...
public void verifyexistingcontact() throws InterruptedException, IOException, MessagingException {
    ...
    contact.existingcontact("Amazon");
   
    
    boolean verifyNotes =contact.verifyaddcontact("Amazon");
