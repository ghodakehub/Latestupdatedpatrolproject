...
public class postInvoice_forSC extends NewBaseTest {
	...
	public void verifyInvoice() throws InterruptedException {
		 try {
		      ...
		      create.searchAndOpenCase("SAMARTH GUPTA vs. M/S OMAXE LIMITED");
		      postInvoice_casedetailspage invoice= new postInvoice_casedetailspage(driver);
		      invoice.createinvoice("Invoice ");
		      invoice.addInvoice("Case law research","kumar", "Contingency Fee", "15 Days");
		    ...
		    //  Assert.assertTrue(isValid, "Link validation failed!");
		        if (!isValid) {
		           ...
		           Library.errorUrls.add(url);
		             ...
		             String message = "please check Issue coming while post Invoice . Please check the attached report.";
