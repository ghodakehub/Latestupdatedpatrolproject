...
public class createdoc_casedetailsforDC extends NewBaseTest {
	
	 @Test(description = "Verify case details document tab")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies user can add document in case details page of District court cases successfully")
	...
	public void VerifyCreateDoc_oncasedetailpage() throws InterruptedException {
		...
		try {
		      ...
		      create.searchAndOpenCase("Axis Bank Limited vs. RAKESH SUVARNA");
