...
public class CreateMatter_casedetailsforHC extends NewBaseTest {
	
	 @Test(description = "Verify Matter tab on case details page for HighCourt")
	...
	public void verifycreatematterforsc() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.searchAndOpenCase("SHUBHAM AGRAWAL vs. AKANKSHA AGARWAL");
		        ...
		        boolean isMatterAdded = create.verifyMatter("SHUBHAM AGRAWAL vs. AKANKSHA AGARWAL");
