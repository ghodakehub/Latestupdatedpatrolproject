...
public class postInvoice_casedetailsforDC extends NewBaseTest {
	
	 @Test(description = "Verify case details Invoice tab for District courts")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies user can add Invoice in case details page of District court cases successfully")
	...
	public void verifyInvoice() throws InterruptedException {
		 try {
		      ...
		      create.searchAndOpenCase("Krishan Kumar vs. Deputy Excise and Taxation Commissionwer");
