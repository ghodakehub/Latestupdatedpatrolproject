...
public class CreateMatter_casedetailspageforDC extends NewBaseTest {
	
	 @Test(description = "Verify Matter tab on case details page for DistrictCourt")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies create matters for District court in case details page successfully")
	
	public void verifyaddmatterforDC() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.createMatter("pharma1", "testing department", "Administrative", "Pending", "Hourly");

		        // Verify if matter is added successfully
		        boolean isMatterAdded = create.verifyMatter("VATIKA HOTELS PVT LTD vs. LENSKART SOLUTIONS PRIVATE LIMITED");
