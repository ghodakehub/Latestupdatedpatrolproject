...
public class PostInvoice_CasedetailsforTC  extends NewBaseTest {
	
	 @Test(description = "Verify case details Invoice tab for Tribunal courts")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies user can add Invoice in case details page of Tribunal court cases successfully")
	...
	public void verifyInvoice() throws InterruptedException {
		 try {
		      ...
		      create.searchAndOpenCase("PRASANNA KUMAR S A vs. BANK OF BARODA");
		      postInvoice_casedetailspage invoice= new postInvoice_casedetailspage(driver);
		      invoice.createinvoice("Invoice ");
		      invoice.addInvoice("Case law research","kumar", "Contingency Fee", "7 Days");
