...
public class CreateNote_casedetailsForSC extends NewBaseTest {
	
	 @Test(description = "Verify Note tab in Case details page of supreme courts cases")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies that user can add note in case details page of Supreme courts cases successfully")
	...
	public void VerifyaddNote_oncasedetailpage() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.searchAndOpenCase("M/S. DATA INFOSYS PVT. LTD. vs. M/S. SOFT (INDIA) SERVICES PVT. LTD.");
