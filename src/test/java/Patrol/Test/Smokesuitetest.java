...
public class Smokesuitetest extends NewBaseTest {
	

	@Test(description = "Verify SmokeSuite")
	 @Severity(SeverityLevel.CRITICAL)
	 @Description("This test verifies when click on all modules are open successfully")
	...
	public void verifyordertracker() {
		...
		SmokeSuite suite= new SmokeSuite(driver);
		suite.runSmokeTest();
