...
public class createcontact_casedetailsforDC extends NewBaseTest{
	
@Test(description = "Verify All Contact tab on case details page for District court Cases")
...
public void allcasedetails() throws InterruptedException, IOException, MessagingException {
    ...
    create.searchAndOpenCase("HASAN ALI vs. State of UT Chandigarh");
    ...
    contact.createcontacts2("Company","HCL", "8867907763", "XYZ@gmail.com", "ITservices", "Chennai");
