...
public class CaseDetails_CreateDocforHC extends NewBaseTest {
	
	 @Test(description = "Verify case details document tab")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies user can add document in case details page of high court cases successfully")
