...
public class CreateNotes_casedetailsforDC extends NewBaseTest {
	
	 @Test(description = "Verify Note tab in Case details page of District courts cases")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies that the user can successfully add a note in the case details page of District Court cases.")
	...
	public void VerifyaddNote_oncasedetailpage() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.searchAndOpenCase("VATIKA HOTELS PVT LTD vs. LENSKART SOLUTIONS PRIVATE LIMITED");
	        	...
	        	Library.addScreenshotToList(driver, "notefailed.png");

	        	 AllureListeners.captureScreenshot(driver, "notes.png");
	             String url = driver.getCurrentUrl();
	           Library.errorUrls.add(url);
	             Allure.addAttachment("URL", url);
	             String message = "please check Issue coming while create Notes . Please check the attached report.";
	             String subject = "Company Name: " + Library.companyName + " Notes tab";
	             
	             EmailUtility.sendSummaryEmailWithScreenshots(driver, subject, message, Library.errorUrls, Library.screenshotBytesList);
	         }

	         Allure.step("Test Case Passed: Note is successfully created and verified.");
	     } catch (Exception e) {
