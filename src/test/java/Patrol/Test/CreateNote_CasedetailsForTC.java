...
public class CreateNote_CasedetailsForTC extends NewBaseTest {
	
	 @Test(description = "Verify Note tab in Case details page of Tribunal courts cases")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies that the user can successfully add a note in the case details page of Tribunal Court cases")
	...
	public void VerifyaddNote_oncasedetailpage() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.searchAndOpenCase("Sanjai Kumar Gupta VS Kashvi Power & Steel Private Limited");
