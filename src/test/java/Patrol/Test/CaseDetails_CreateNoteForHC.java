...
public class CaseDetails_CreateNoteForHC extends NewBaseTest {
	
	 @Test(description = "Verify Note tab in Case details page")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies that user can add note in case details page of high courts cases successfully")
