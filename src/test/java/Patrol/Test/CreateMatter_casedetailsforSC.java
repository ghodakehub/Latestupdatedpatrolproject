...
public class CreateMatter_casedetailsforSC extends NewBaseTest {
	
	 @Test(description = "Verify Matter tab on case details page for Supremecourt")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies create matters for supreme court in case details page successfully")
	...
	public void verifycreatematterforsc() throws InterruptedException {
		 ...
		 try {
		        ...
		        create.searchAndOpenCase("DATA INFOSYS LTD. vs. INFOSYS TECHNOLOGIES LTD.");
		        ...
		        boolean isMatterAdded = create.verifyMatter("DATA INFOSYS LTD. vs. INFOSYS TECHNOLOGIES LTD.");
