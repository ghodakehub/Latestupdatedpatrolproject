...
public class createdoc_casedetailsforTC extends NewBaseTest {
	
	 @Test(description = "Verify case details document tab")
	    @Severity(SeverityLevel.CRITICAL) 
	    @Description("This test verifies user can add document in case details page of Tribunal court cases successfully")
	...
	public void VerifyCreateDoc_oncasedetailpage() throws InterruptedException {
		...
		try {
		      ...
		      create.searchAndOpenCase("SHAKATI SINGH BHATI vs. STATE OF RAJASTHAN");
