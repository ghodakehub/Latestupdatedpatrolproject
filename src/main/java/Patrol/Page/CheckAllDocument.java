...
public class CheckAllDocument  extends BasePage {
	
	public CheckAllDocument(WebDriver driver) {
		super(driver);
	}
	//*[@id="matter_view"]/div[4]/div/div[2]/a/span
	@FindBy (xpath = "//*[@id=\"tab1-content\"]/div[1]/div[4]/div/div[2]/a/span")
	...
	public void VerifyDoc2() {
      ...
      for (int p = 0; p < pagination.size(); p++) {
          ...
          List<WebElement> matterLinks = driver.findElements(By.xpath("//*[@id=\"tab1\"]/div/table/tbody/tr/td[3]/p/a"));
          ...
          for (int i = 0; i < matterLinks.size(); i++) {
              try {
                  ...
                  matterLinks = driver.findElements(By.xpath("//*[@id=\"tab1\"]/div/table/tbody/tr/td[3]/p/a"));
